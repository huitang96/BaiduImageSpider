...
class Crawler:
    ...
    __start_amount = 0
    __counter = 0
    headers = {'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.107 Safari/537.36', 'Cookie': ''}
    __per_page = 30
    ...
    def save_image(self, rsp_data, word):
        ...
        for image_info in rsp_data['data']:
            try:
                ...
                # https: // www.google.com.hk / imghp?hl = zh - CN & tab = ii
...
if __name__ == '__main__':
    if len(sys.argv) > 1:
        ...
        crawler.start('10岁女生', 10, 2, 30)  # 抓取关键词为 “美女”，总数为 1 页，开始页码为 2，每页30张（即总共 2*30=60 张）
